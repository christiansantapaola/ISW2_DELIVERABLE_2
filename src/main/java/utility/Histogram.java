 ...
 * A utility.Histogram is a Data Structure that given a Type K that must implements equals and Comparable interface
 * Given an Object K, it tells how many Objects J so that J == K were inserted inside the utility.Histogram.
...
public class Histogram<K> {
    ...
    /**
     * Constructor of a utility.Bucket.
     */
    public Histogram() {
